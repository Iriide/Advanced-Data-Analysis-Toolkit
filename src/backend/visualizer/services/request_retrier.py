...
class GeminiAPIRequestRetrier:
    ...
    def _extract_status_from_error(
        self, error: genai.errors.ClientError
    ...
    def _extract_wait_time_from_error(
        self, error: genai.errors.ClientError, zero_to_minute: bool = True
    ) -> int:
    ...
    def _handle_client_error(self, error: genai.errors.ClientError) -> int:
    ...
    def _handle_server_error(self, error: genai.errors.ServerError) -> int:
